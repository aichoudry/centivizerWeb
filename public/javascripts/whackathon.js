	...
	var game = (function() {
		...
		init = function(parentId)
		{
			...
			{				
				...
				// Create image
				var moleImg = $("<img></img>", {id: "Mole_"+i, class:'mole hidden', src:'images/whack/mole' + i + '.jpg'})
				...
				// Add the whack =)
				var whackImg = $("<img></img>", {id: "Whack_" + 1, class:'whack', src:"images/whack/whack.png"});
	  ...
	  update = function(step)
	  {
		for (var i=0; i<moleCount; i++)
		{
			...
			{				
				if (mole.state == "dead")
				{
					$("#Mole_" + mole.id).attr("src", 'images/whack/mole' + getRandomInt(0, moleCount-1) + '.jpg');
					mole.state = "alive";
