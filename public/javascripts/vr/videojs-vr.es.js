...
import { BufferGeometry, CubeGeometry, DoubleSide, LinearFilter, Mesh, MeshBasicMaterial, PerspectiveCamera, RGBAFormat, RGBFormat, Scene, ShaderMaterial, SphereBufferGeometry, SphereGeometry, Vector2, Vector3, VideoTexture, WebGLRenderer } from 'three';
...
window$1.WebVRConfig = WebVRConfig$1;
...
var wgluPreserveState = WGLUPreserveGLState;
...
CardboardUI.prototype.onResize = function() {
  ...
  wgluPreserveState(gl, glState, function(gl) {
    var vertices = [];
...
var format = 1;
var last_updated = "2017-08-27T14:39:31Z";
...
var dpdb$3 = (Object.freeze || Object)({
	format: format,
	last_updated: last_updated,
	devices: devices,
	'default': dpdb$2
...
VRDisplay$3.prototype.getFrameData = function(frameData) {
  // TODO: Technically this should retain it's value for the duration of a frame
  // but I doubt that's practical to do in javascript.
  return util.frameDataFromPose(frameData, this.getPose(), this);
};

VRDisplay$3.prototype.getPose = function() {
  // TODO: Technically this should retain it's value for the duration of a frame
  // but I doubt that's practical to do in javascript.
  return this.getImmediatePose();
};

VRDisplay$3.prototype.requestAnimationFrame = function(callback) {
  return window.requestAnimationFrame(callback);
};

VRDisplay$3.prototype.cancelAnimationFrame = function(id) {
  return window.cancelAnimationFrame(id);
};

VRDisplay$3.prototype.wrapForFullscreen = function(element) {
  // Don't wrap in iOS.
  if (util.isIOS()) {
    return element;
  }
...
VRDisplay$3.prototype.removeFullscreenWrapper = function() {
...
VRDisplay$3.prototype.requestPresent = function(layers) {
...
VRDisplay$3.prototype.exitPresent = function() {
  var wasPresenting = this.isPresenting;
  var self = this;
  this.isPresenting = false;
  this.layer_ = null;
...
VRDisplay$3.prototype.getLayers = function() {
  if (this.layer_) {
    return [this.layer_];
  }
  return [];
...
VRDisplay$3.prototype.fireVRDisplayPresentChange_ = function() {
...
VRDisplay$3.prototype.fireVRDisplayConnect_ = function() {
  // Important: unfortunately we cannot have full spec compliance here.
  // CustomEvent custom fields all go under e.detail (so the VRDisplay ends up
  // being e.detail.display, instead of e.display as per WebVR spec).
...
VRDisplay$3.prototype.addFullscreenListeners_ = function(element, changeHandler, errorHandler) {
...
VRDisplay$3.prototype.removeFullscreenListeners_ = function() {
...
VRDisplay$3.prototype.beginPresent_ = function() {
  // Override to add custom behavior when presentation begins.
};

VRDisplay$3.prototype.endPresent_ = function() {
  // Override to add custom behavior when presentation ends.
};

VRDisplay$3.prototype.submitFrame = function(pose) {
  // Override to add custom behavior for frame submission.
};

VRDisplay$3.prototype.getEyeParameters = function(whichEye) {
 ...
 */
function HMDVRDevice$1() {
}
HMDVRDevice$1.prototype = new VRDevice();

/**
 * The base class for all VR position sensor devices. (Deprecated)
 */
function PositionSensorVRDevice$1() {
}
PositionSensorVRDevice$1.prototype = new VRDevice();

var VRFrameData_1 = VRFrameData$2;
var VRDisplay_1 = VRDisplay$3;
var VRDevice_1 = VRDevice;
var HMDVRDevice_1 = HMDVRDevice$1;
var PositionSensorVRDevice_1 = PositionSensorVRDevice$1;

var base = {
	VRFrameData: VRFrameData_1,
	VRDisplay: VRDisplay_1,
	VRDevice: VRDevice_1,
	HMDVRDevice: HMDVRDevice_1,
	PositionSensorVRDevice: PositionSensorVRDevice_1
};
...
var VRDisplay$2 = base.VRDisplay;
...
CardboardVRDisplay.prototype = new VRDisplay$2();
...
var VRDisplay$4 = base.VRDisplay;
...
MouseKeyboardVRDisplay.prototype = new VRDisplay$4();
...
var mouseKeyboardVrDisplay = MouseKeyboardVRDisplay;

var HMDVRDevice$2 = base.HMDVRDevice;
var PositionSensorVRDevice$2 = base.PositionSensorVRDevice;

/**
 * Wraps a VRDisplay and exposes it as a HMDVRDevice
 */
function VRDisplayHMDDevice$1(display) {
...
VRDisplayHMDDevice$1.prototype = new HMDVRDevice$2();

VRDisplayHMDDevice$1.prototype.getEyeParameters = function(whichEye) {
...
VRDisplayHMDDevice$1.prototype.setFieldOfView =
 ...
 */
function VRDisplayPositionSensorDevice$1(display) {
  this.display = display;
...
VRDisplayPositionSensorDevice$1.prototype = new PositionSensorVRDevice$2();

VRDisplayPositionSensorDevice$1.prototype.getState = function() {
...
VRDisplayPositionSensorDevice$1.prototype.resetState = function() {
  return this.positionDevice.resetPose();
};


var VRDisplayHMDDevice_1 = VRDisplayHMDDevice$1;
var VRDisplayPositionSensorDevice_1 = VRDisplayPositionSensorDevice$1;

var displayWrappers = {
	VRDisplayHMDDevice: VRDisplayHMDDevice_1,
	VRDisplayPositionSensorDevice: VRDisplayPositionSensorDevice_1
};

var _args = [["webvr-polyfill@0.9.38","/Users/farzad/developer/node/pizza"]];
var _from = "webvr-polyfill@0.9.38";
var _id = "webvr-polyfill@0.9.38";
var _inBundle = false;
var _integrity = "sha512-HABweqWYE0suk6P5TdHlagJK56HSecB5xKj6ZshocrxSj9UmNOCjCRv4vFYHCaFZKtuKWa8niRHVbJ3Vo7JYDg==";
var _location = "/webvr-polyfill";
var _phantomChildren = {};
var _requested = {"type":"version","registry":true,"raw":"webvr-polyfill@0.9.38","name":"webvr-polyfill","escapedName":"webvr-polyfill","rawSpec":"0.9.38","saveSpec":null,"fetchSpec":"0.9.38"};
var _requiredBy = ["/"];
var _resolved = "https://registry.npmjs.org/webvr-polyfill/-/webvr-polyfill-0.9.38.tgz";
var _spec = "0.9.38";
var _where = "/Users/farzad/developer/node/pizza";
...
var description$1 = "Use WebVR today, on mobile or desktop, without requiring a special browser build.";
var devDependencies$1 = {"chai":"^3.5.0","jsdom":"^9.12.0","mocha":"^3.2.0","semver":"^5.3.0","webpack":"^2.6.1","webpack-dev-server":"^2.4.5"};
var homepage = "https://github.com/googlevr/webvr-polyfill";
var keywords$1 = ["vr","webvr"];
var license$1 = "Apache-2.0";
var main$3 = "src/node-entry";
var name$1 = "webvr-polyfill";
var repository$1 = {"type":"git","url":"git+https://github.com/googlevr/webvr-polyfill.git"};
var scripts$1 = {"build":"webpack","start":"npm run watch","test":"mocha","watch":"webpack-dev-server"};
var version$2 = "0.9.38";
var _package$1 = {
	_args: _args,
	_from: _from,
	_id: _id,
...
var _package$2 = (Object.freeze || Object)({
	_args: _args,
	_from: _from,
	_id: _id,
	_inBundle: _inBundle,
...
var require$$2 = ( _package$2 && _package$1 ) || _package$2;
...
var VRFrameData$1 = base.VRFrameData;
var HMDVRDevice = base.HMDVRDevice;
var PositionSensorVRDevice = base.PositionSensorVRDevice;
var VRDisplayHMDDevice = displayWrappers.VRDisplayHMDDevice;
var VRDisplayPositionSensorDevice = displayWrappers.VRDisplayPositionSensorDevice;
var version$1 = require$$2.version;

function WebVRPolyfill$1() {
  this.displays = [];
...
WebVRPolyfill$1.prototype.isWebVRAvailable = function() {
  return ('getVRDisplays' in navigator);
};

WebVRPolyfill$1.prototype.isDeprecatedWebVRAvailable = function() {
  return ('getVRDevices' in navigator) || ('mozGetVRDevices' in navigator);
};

WebVRPolyfill$1.prototype.connectDisplay = function(vrDisplay) {
  vrDisplay.fireVRDisplayConnect_();
  this.displays.push(vrDisplay);
};

WebVRPolyfill$1.prototype.populateDevices = function() {
...
WebVRPolyfill$1.prototype.enablePolyfill = function() {
...
WebVRPolyfill$1.prototype.enableDeprecatedPolyfill = function() {
...
WebVRPolyfill$1.prototype.getVRDisplays = function() {
...
WebVRPolyfill$1.prototype.getVRDevices = function() {
...
WebVRPolyfill$1.prototype.NativeVRFrameData = window.VRFrameData;

/**
 * Determine if a device is mobile.
 */
WebVRPolyfill$1.prototype.isMobile = function() {
  return /Android/i.test(navigator.userAgent) ||
      /iPhone|iPad|iPod/i.test(navigator.userAgent);
};

WebVRPolyfill$1.prototype.isCardboardCompatible = function() {
  // For now, support all iOS and Android devices.
  // Also enable the WebVRConfig.FORCE_VR flag for debugging.
  return this.isMobile() || window.WebVRConfig.FORCE_ENABLE_VR;
};

WebVRPolyfill$1.prototype.isFullScreenAvailable = function() {
...
WebVRPolyfill$1.InstallWebVRSpecShim = InstallWebVRSpecShim;
WebVRPolyfill$1.version = version$1;

var WebVRPolyfill_1 = WebVRPolyfill$1;

var webvrPolyfill = {
	WebVRPolyfill: WebVRPolyfill_1
};
...
var WebVRPolyfill = webvrPolyfill.WebVRPolyfill;
...
var VRControls;
var VRControls_1 = VRControls = function ( object, onError ) {

	var scope = this;

	var vrDisplay, vrDisplays;

	var standingMatrix = new THREE__default.Matrix4();
...
var VREffect;
var VREffect_1 = VREffect = function ( renderer, onError ) {

	var vrDisplay, vrDisplays;
	var eyeTranslationL = new THREE__default.Vector3();
	var eyeTranslationR = new THREE__default.Vector3();
	var renderRectL, renderRectR;
	var headMatrix = new THREE__default.Matrix4();
	var eyeMatrixL = new THREE__default.Matrix4();
	var eyeMatrixR = new THREE__default.Matrix4();
	...
	var cameraL = new THREE__default.PerspectiveCamera();
	cameraL.layers.enable( 1 );

	var cameraR = new THREE__default.PerspectiveCamera();
	...
	var poseOrientation = new THREE__default.Quaternion();
	var posePosition = new THREE__default.Vector3();
	...
	function fovPortToProjection( fov, rightHanded, zNear, zFar ) {
		...
		var mobj = new THREE__default.Matrix4();
		var m = mobj.elements;
...
var webvrManager = createCommonjsModule(function (module, exports) {
...
var CardboardButton = function (_Button) {
  ...
  function CardboardButton(player, options) {
    ...
    _this.handleVrDisplayActivate_ = videojs.bind(_this, _this.handleVrDisplayActivate_);
    _this.handleVrDisplayDeactivate_ = videojs.bind(_this, _this.handleVrDisplayDeactivate_);
    _this.handleVrDisplayPresentChange_ = videojs.bind(_this, _this.handleVrDisplayPresentChange_);
    _this.handleOrientationChange_ = videojs.bind(_this, _this.handleOrientationChange_);
  ...
  CardboardButton.prototype.handleVrDisplayPresentChange_ = function handleVrDisplayPresentChange_() {
  ...
  CardboardButton.prototype.handleOrientationChange_ = function handleOrientationChange_() {
  ...
  CardboardButton.prototype.handleVrDisplayActivate_ = function handleVrDisplayActivate_() {
  ...
  CardboardButton.prototype.handleVrDisplayDeactivate_ = function handleVrDisplayDeactivate_() {
...
var BigVrPlayButton = function (_BigPlayButton) {
  ...
  function BigVrPlayButton() {
    ...
    return possibleConstructorReturn(this, _BigPlayButton.apply(this, arguments));
  }
...
window$1.WebVRManager = webvrManager;

var validProjections = ['360', '360_LR', '360_TB', '360_CUBE', 'NONE', 'AUTO', 'Sphere', 'Cube', 'equirectangular'];
...
var isHLS = function isHLS(currentType) {
  // hls video types
  var hlsTypes = [
  // Apple santioned
  ...
  // this is hls
  return hlsTypes.some(function (type) {
    return new RegExp('^' + type + '$', 'i').test(currentType);
  });
};
...
var VR = function (_Plugin) {
  ...
  function VR(player, options) {
    ...
    var _this = possibleConstructorReturn(this, _Plugin.call(this, player, settings));
  ...
  VR.prototype.changeProjection_ = function changeProjection_(projection) {
    ...
    if (projection === 'AUTO') {
      ...
      this.movieGeometry = new CubeGeometry(256, 256, 256);
      var face1 = [new Vector2(0, 0.5), new Vector2(0.333, 0.5), new Vector2(0.333, 1), new Vector2(0, 1)];
      var face2 = [new Vector2(0.333, 0.5), new Vector2(0.666, 0.5), new Vector2(0.666, 1), new Vector2(0.333, 1)];
      var face3 = [new Vector2(0.666, 0.5), new Vector2(1, 0.5), new Vector2(1, 1), new Vector2(0.666, 1)];
      var face4 = [new Vector2(0, 0), new Vector2(0.333, 1), new Vector2(0.333, 0.5), new Vector2(0, 0.5)];
      var face5 = [new Vector2(0.333, 1), new Vector2(0.666, 1), new Vector2(0.666, 0.5), new Vector2(0.333, 0.5)];
      var face6 = [new Vector2(0.666, 1), new Vector2(1, 0), new Vector2(1, 0.5), new Vector2(0.666, 0.5)];
  ...
  VR.prototype.log = function log(msg) {
    if (this.options_.debug) {
      videojs.log(msg);
    }
  };

  VR.prototype.handleVrDisplayActivate_ = function handleVrDisplayActivate_() {
    this.manager.enterVRMode_();
    this.manager.setMode_(3);
  };

  VR.prototype.handleVrDisplayDeactivate_ = function handleVrDisplayDeactivate_() {
  ...
  VR.prototype.init = function init() {
    ...
    this.controls3d = new VRControls_1(this.camera);
    ...
    if (this.videoTexture.format === RGBAFormat && this.videoTexture.flipY === false) {
    ...
    } else if (this.videoTexture.format === RGBFormat && this.videoTexture.flipY === false) {
      this.movieMaterial = new ShaderMaterial({
        uniforms: {
          texture: { value: this.videoTexture }
        },
      ...
      this.movieMaterial = new MeshBasicMaterial({ map: this.videoTexture, overdraw: true, side: DoubleSide });
    }
    ...
    this.effect = new VREffect_1(this.renderer);
    ...
    var debounce = function debounce(fn, wait) {
      ...
      return function () {
        ...
        timeout = window$1.setTimeout(function () {
    ...
    var setInherit = debounce(function (mut) {
      if (_this2.observer_) {
        _this2.observer_.disconnect();
      } else {
        _this2.observer_ = new window$1.MutationObserver(setInherit);
      }
      _this2.renderedCanvas.setAttribute('style', 'width: inherit; height: inherit;');
      _this2.handleResize_();
      _this2.observer_.observe(_this2.renderedCanvas, {
        attributes: true,
        attributeList: ['style']
      });
    }, 10);
    ...
    if (window$1.navigator.getVRDisplays) {
      window$1.navigator.getVRDisplays().then(function (displays) {
        if (displays.length > 0) {
          _this2.log('WebVR supported, VRDisplays found.');
          _this2.vrDisplay = displays[0];
          _this2.log(_this2.vrDisplay);
          ...
          if (!_this2.vrDisplay.isPolyfilled) {
            _this2.addCardboardButton_();
          }
          ...
          _this2.triggerError_({ code: 'web-vr-no-devices-found', dismiss: false });
        }
      });
  ...
  VR.prototype.reset = function reset() {
    ...
    window$1.removeEventListener('resize', this.handleResize_);
    window$1.removeEventListener('vrdisplaypresentchange', this.handleResize_);
    window$1.removeEventListener('vrdisplayactivate', this.handleVrDisplayActivate_);
    window$1.removeEventListener('vrdisplaydeactivate', this.handleVrDisplayDeactivate_);
