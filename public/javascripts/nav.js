...
if ('qweasd'.indexOf(String.fromCharCode(event.which)) !== -1 ){
        ...
        if (firstBIDNo === -1){
          ...
          var boro = 'http://192.168.0.100:3000/vr?vid=' + data[firstBIDNo][Number(keyMapp.indexOf(String.fromCharCode(event.which))) -1]["link"];
     ...
     var socket = io();
        ...
        */
        ...
        if (firstBIDNo === -1){
          ...
          var boro = 'http://192.168.0.100:3000/vr?vid=' + data[firstBIDNo][Number(msg.buttonNo) -1]["link"];
          window.location.href = boro;
